        ...
        <div className="dropdown-menu dropdown-menu-lg" id="search-dropdown">
          <SimpleBar style={{ height: '320px' }}>
            ...
            <Link to="#" className="dropdown-item notify-item">
              <i className="ri-bubble-chart-line align-middle fs-xl text-muted me-2"></i>
              <span>Analytics Dashboard</span>
            </Link>

            <Link to="#" className="dropdown-item notify-item">
              <i className="ri-lifebuoy-line align-middle fs-xl text-muted me-2"></i>
              <span>Help Center</span>
            </Link>

            <Link to="#" className="dropdown-item notify-item">
              <i className="ri-user-settings-line align-middle fs-xl text-muted me-2"></i>
              ...
              <Link to="#" className="dropdown-item notify-item py-2">
                <div className="d-flex">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="fs-2xs mb-0 text-muted">Manager</span>
                  </div>
                </div>
              </Link>
              ...
              <Link to="#" className="dropdown-item notify-item py-2">
                <div className="d-flex">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="fs-2xs mb-0 text-muted">Web Designer</span>
                  </div>
                </div>
              </Link>
              ...
              <Link to="#" className="dropdown-item notify-item py-2">
                <div className="d-flex">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="fs-2xs mb-0 text-muted">
                      React Developer
                    </span>
                  </div>
                </div>
