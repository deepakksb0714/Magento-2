    ...
    <React.Fragment>
      ...
      >
        <Dropdown.Toggle
          id="notification"
          type="button"
          className="btn btn-icon btn-topbar btn-ghost-primary rounded-circle arrow-none"
        >
            ...
            <div className="p-3 bg-primary bg-pattern">
              <Row className="align-items-center">
                ...
                <div className="col-auto dropdown-tabs">
                  <span className="badge bg-light-subtle text-light  fs-13">
                    {' '}
                    4 New
                  </span>
                </div>
                  ...
                  <div className="d-flex">
                    ...
                    <div className="flex-1">
                      <a href="#!" className="stretched-link">
                        <h6 className="mt-0 mb-1 fs-14 fw-semibold">
                          Angela Bernier
                        </h6>
                      </a>
