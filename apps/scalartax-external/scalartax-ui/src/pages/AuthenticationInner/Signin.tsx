...
const Signin = () => {
  document.title = 'Login | ScalarTax';
                  ...
                  <div className="d-flex flex-column h-100 py-0 py-xl-4">
                        ...
                        <Col lg={6}>
                          <Card.Body className="p-lg-5 p-4">
                            <div className="text-center">
                              <h5 className="mb-0">
                                <span style={{ color: 'rgb(250, 70, 22)' }}>
                                  Welcome Back !
                                </span>
                              </h5>
                              <p className="text-muted mt-2">
                                Sign in to continue to ScalarHub.
                              </p>
                            </div>
                    ...
                    <div className="mt-5 text-center">
                      <p className="mb-0 text-muted">
                        &copy; {new Date().getFullYear()} ScalarHub{' '}
                        <i className="mdi mdi-heart text-danger"></i> all right
                      </p>
                    </div>
                  </div>
                </div>
