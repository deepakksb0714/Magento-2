...
export const GridData = [
  {
    ...
    Notes:
      'SST sellers should use codes 0, 1, 2, 3, 4, 9, and 10. ProcessCode 0 voids values in DocCode, DocType, and entityCode. Use caution with tax overrides (1, 2, 5, 6, 9, 10).',
  },
  {
    Column: 'B',
    Name: 'DocCode',
  ...
  },
  {
    Column: 'AA',
    Name: 'OrigRegion',
    Meaning: "The or ship-from state or province's abbreviation.",
  ...
  },
  {
    Column: 'AB',
    Name: 'OrigPostCode',
    Meaning: "The or ship-from state or province's postal code.",
  ...
  },
  {
    Column: 'AC',
    Name: 'OrigCountry',
    Meaning: "The or ship-from country's abbreviation.",
    PossibleValues: 'A country abbreviation (2)',
    Notes: '',
  },
  {
  ...
  },
  {
    Column: 'Y',
    Name: 'OrigAddress',
    Meaning: 'The or ship-from street address.',
    PossibleValues: 'Text or a LocationCode (50)',
...
export const originCoordinates = ['Latitude', 'Longitude'];
