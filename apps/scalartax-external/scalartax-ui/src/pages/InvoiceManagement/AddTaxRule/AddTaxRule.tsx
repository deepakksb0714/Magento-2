...
import { addTaxRule as onAddTaxRule } from '../../../slices/thunk';
import { usePrimaryEntity } from '../../../Common/usePrimaryEntity';
import { useTaxTypeHandler } from "./taxTypeUtils"
import { countryData } from '../../../Common/data/countryState';
import { jurisdictionsData } from '../../../Common/data/nexus';

function AddTaxRule() {

    document.title = 'ADD CUSTOM RULE  | Dashboard';
    ...
    const formik = useFormik({
        initialValues: {
            ...
            capOption: '',
            threshold: '',
            thresholdAppliedValue: '',
            taxEntireAmount: false,
            baseValue: '',
            rateValue: '',
        },
        validationSchema: Yup.object({
            ...
            jurisdictionName: Yup.string().when('disableJurisdiction', (disableJurisdiction:boolean, schema:any) =>
                disableJurisdiction
                    ? schema.notRequired() // Field is not required when disableJurisdiction is true
                    : schema.required('Jurisdiction is required') // Field is required when disableJurisdiction is false
            ),
        ...
        onSubmit: (values: any) => {
            ...
            dispatch(onAddTaxRule(data));
            navigate('/tax-rules');
        },
    });

    useEffect(() => {
        if (!formik.values.ruleType) {
            formik.setFieldValue('ruleType', 'productTaxabilityRule');
        }
    }, [formik]);
    const {
    ...
    // useEffect(() => {
    //     if (formik.values.taxType || formik.values.taxSubType || formik.values.rateType || formik.values.jurisdictionType) {
    //         handleRateTypeChange(formik.values.taxType, formik.values.taxSubType,formik.values.rateType,formik.values.jurisdictionType);
    //     }
    // },[formik.values.taxType, formik.values.taxSubType,formik.values.rateType,formik.values.jurisdictionType])

    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb pageTitle="Add custom rule" title="Add custom rule" />
                    <Card>
                        <Card.Body>
                            <div className="p-2">
                                <b>
                                    ...
                                    <Row className="mb-3 mt-4">
                                        ...
                                        <Col md={6}>
                                                ...
                                                formik.values.ruleType !== "baseOverrideRule" && (
                                                    <>
                                                        <Form.Group className="mb-3">
                                                            ...
                                                            >
                                                                <option>Select a tax subtype</option>
                                                                {availableSubTaxTypes.map((subType:any) => (
                                                    ...
                                                    <>
                                                        <Form.Group className="mb-3">
                                                            ...
                                                            <Form.Control
                                                                ...
                                                                // onChange={(e:any) => {
                                                                //     formik.handleChange(e);
                                                                //     handleJurisTypeChange(formik.values.taxType, formik.values.taxSubType, formik.values.rateType, e.target.value)
                                                                // }}
                                                                onChange={formik.handleChange}
                                                                onBlur={formik.handleBlur}
                                                            ...
                                                            >
                                                                <option>Select a jurisdiction type</option>
                                                                {availablejurisdictionValues.map((jurisType:any) => (
                                            ...
                                            <Form.Group className="mb-3">
                                                ...
                                                <p style={{ fontSize: "16px" }}>Assign the appropriate tax code for this</p>
                                                <Form.Control
                                                    id="taxCode"
                                                    name="taxCode"
                                                    type="text"
                                            ...
                                            <h4><b>2. Tax Treatment :</b></h4>
                                            {
                                                formik.values.ruleType === "productTaxabilityRule" && (
                                                    <>
                                                                    ...
                                                                    <div style={{ display: 'flex', gap: '10px' }}>
                                                                        ...
                                                                        <Form.Control
                                                                            ...
                                                                            onChange={(e:any) => {
                                                                                ...
                                                                                formik.setFieldValue("capAppliedValue}", selectedValue); //
                                                                            }}
                                                            ...
                                                            <div>
                                                                ...
                                                                <Form.Group className="mb-3">
                                                                    ...
                                                                    <div style={{ display: 'flex', gap: '10px' }}>
                                                                        ...
                                                                        <Form.Control
                                                                            as="select"
                                                                            id="thresholdAppliedValue"
                                                                            name="thresholdAppliedValue"
                                                                            onChange={(e:any) => {
                                                                                const selectedValue = e.target.value;
                                                                                formik.handleChange(e); // Update Formik state
                                                                                formik.setFieldValue("thresholdAppliedValue", selectedValue); //
                                                                            }}
                                                        ...
                                                        <hr />
                                                        <Button variant="link"
                                                            onClick={() => toggleOption("showJurisdictionsRule")}
                                                            className="mt-2">
                                                            {showOptions ? "Advanced Options" : "Advanced Options"}
                                                        </Button>

                                                        {showOptions.showJurisdictionsRule && (
                                                            <div>
                                                    ...
                                                    <div style={{ marginBottom: "2rem" }}>
                                                        ...
                                                        <div style={{ display: "flex", alignItems: "center", marginBottom: "0.5rem" }}>
                                                            <Form.Check
                                                                ...
                                                                onChange={formik.handleChange}
                                                                checked={formik.values.isAllJuris === "all"}
                                                            />
                                                        </div>
                                                        <div style={{ display: "flex", alignItems: "center" }}>
                                                            <Form.Check
                                                                ...
                                                                value="only"
                                                                onChange={formik.handleChange}
                                                                checked={formik.values.isAllJuris === "only"}
                                                            />
                                                        </div>
                                                    </div>
                                                </div>
