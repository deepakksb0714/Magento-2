...
const Taxes = () => {
  document.title = 'Taxes | Scalarhub';
    ...
    () => [
      ...
      },
      {
        ...
        Cell: (cell: any) => {
          return (
            <span
              className={`badge bg-${cell.row.original.color}-subtle text-${cell.row.original.color} p-2`}
            >
        ...
        <Container fluid>
          ...
          <Row className="pb-4 gy-3">
            <div className="col-sm-4">
              <Button
                variant="primary"
                className="addtax-modal"
                onClick={() => tog_standard()}
              >
                <i className="las la-plus me-1"></i> Add Taxes
              </Button>
            </div>
